...
const CONTRACT_NAME = "TestERC1155OpenSea";
...
async function deploy() {
  ...
  console.log(`Deploying ${CONTRACT_NAME} with parameters: "${PROXY_REGISTRY_ADDRESS[networkName]}"`);
  const contract = await factory.deploy(PROXY_REGISTRY_ADDRESS[networkName]);
