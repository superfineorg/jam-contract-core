...
const CONTRACT_NAME = "NFTStaking";
...
async function deploy() {
  ...
  console.log(`Deploying ${CONTRACT_NAME} with parameters: "${180}" "${"2000000000000000000"}"`);
  const contract = await factory.deploy(180, "2000000000000000000");
