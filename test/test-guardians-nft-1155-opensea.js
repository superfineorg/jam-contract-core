...
const GAMEJAM_NFT_1155 = "JamNFT1155OpenSea";
...
describe("Test JamNFT1155 contract", () => {
  ...
  it("Check URI of non-existent NFTs", async () => {
    await expect(this.nft1155Contract.uri(100)).to.be.revertedWith("JamNFT1155OpenSea: URI query for non-existent token");
  });
